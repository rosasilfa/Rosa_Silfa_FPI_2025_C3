...
void main(void)
{
    ...
    caracter de temrinacion '\0' a la posicion de memoria a la que apunta la
    varaible cad0 -apuntador del tipo cadena de caracteres. */
    ...
    char cad3[] = {'B', 'i', 'e', 'n', 'v', 'e', 'n', 'i', 'd', 'd', '\0'};
    ...
    para leer una cadena de caracteres, auqnue con algunas restricciones. Si la
    ...
    ello esra funcion unicamente es util si conocemos con anticipacion que la

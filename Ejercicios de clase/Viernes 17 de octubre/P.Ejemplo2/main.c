...
/* Suma matrices.
El prorama, al recibir como datos dos arrelos bidimensionales del mismo
tamaño, calcula la suma de ambos y la almacena en un tercer arrelo
bidimensional. */
...
void main(void)
{
    ...
    /* Declaración de los tres arrelos */
    int FIL, COL;
    do
    {
        printf("Ingrese el numero de filas de los arrelos: ");
        scanf("%d", &FIL);
    }
    while (FIL> MAX || FIL< 1);
...
/* La función Lecutra se utiliza para leer un arreglo bidimensional entero de F
filas y C columnas. */
{
    int I, J;
    for (I=0; I<F; I++)

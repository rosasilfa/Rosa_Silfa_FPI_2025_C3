...
/* Esta función se utiliza para localizar el mes con mayor registro de lluvia en
la provincia 18 en el quinto año. Escribe además el resgistro correspondiente. */
{
    int J, EMES = -1;
    float ELLU = -1.0;
    for (J=0; J<C; J++)

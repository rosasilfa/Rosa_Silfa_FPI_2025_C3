...
/* Se declaran las constantes para la fila, la columna y la profundidad. */
...
corresponde a los años. */
{
    ...
    for (K=0; K<PR; K++)
        /* Por cada año se suma el ingreso de los dos semetres de las ocho carreras.
        */
    {
        SUM = 0;
        for (I=0; I<FI; I++)
...
/* Esta función se utiliza para determinan la carrera que recibió el mayor

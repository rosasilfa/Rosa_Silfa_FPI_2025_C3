...
/* Prueba de variable globales, locales y estáticas.
...
int f4(void)
/* La funci+on f4 utiliza dos variables con el mismo nombre: local
y global. */
{
    int K = 5;
    K = K + K;      /* Uso de la variable loca (K) y global (::K) */
    return (K);
}
